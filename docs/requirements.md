...
| ADV-004 | Engagement Score | 学習コミュニティの健康度を数値化。例: "Server health: 78/100 - Learners are more active this week." **競合差別化ポイント・将来的なコア機能候補** |
...
| プライバシー | メッセージ内容や個人データは収集しない。保存するのは集計値のみ |
...
| 2.6 | 2026-01-30 | DB表記をTursoに統一。価格暫定表記追加。プライバシー要件追加。撤退判断指標追加。ADV-004をコア機能候補と明記。 |
